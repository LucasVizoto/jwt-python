from src.models.repositories.user_repository import UserRepositoryInterface
...
class LoginCreator:
    ...
    def create(self, username: str, password:str)-> dict:
        #primeira cois que eu vou fazer é verificar se o user existe e verificar a senha hash
